			...
			sections: [
				...
				},
				{
					...
					items: [
						...
						'Välj projekt - formuläret uppdateras automatiskt med debiteringsläge',
						'Välj datum - dagens datum är förvalt, använd kalendern för att välja annat datum',
						'Snabbval i kalendern: "Igår" och "I förrgår"',
						'Ange starttid och sluttid med tidsväljaren (popover med +/- knappar)',
						'Standardtider hämtas från organisationens inställningar',
						'Total tid beräknas automatiskt med avdrag för rast enligt settings',
						'Rastavdraget visas på samma rad som "Total tid"',
						'(Valfritt) Välj ÄTA och ange ÄTA-tid som diskonteras från huvudprojektet',
						'Välj fas/arbetsorder om det behövs',
						'Spara',
					],
				},
			],
