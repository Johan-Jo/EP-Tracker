  ...
  return (
    <div className="flex-1 overflow-auto bg-gray-50 transition-colors dark:bg-[#0A0908]">
      ...
      <div className="mt-6" data-tour="quick-actions">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <button 
            ...
            className="group rounded-xl border border-border/60 bg-[var(--color-card)] text-foreground shadow-sm transition-all hover:-translate-y-0.5 hover:border-orange-500/40 hover:shadow-lg min-h-[120px] sm:min-h-[128px] dark:border-border/40 dark:bg-[var(--color-card)]/80 dark:text-white/90"
          >
            <div className="flex items-center gap-4 p-5 sm:p-6">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-muted text-muted-foreground transition-colors group-hover:bg-orange-500/10 group-hover:text-orange-600 dark:bg-white/10 dark:text-white">
                <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="1.5">
              ...
              <div className="text-left">
                <div className="font-medium text-foreground dark:text-white">Logga tid</div>
                <div className="text-sm text-muted-foreground dark:text-white/70">Registrera arbetstid</div>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center gap-4 p-5 sm:p-6">
              ...
              <div className="text-left">
                <div className="font-medium text-foreground dark:text-white">Lägg till material</div>
                <div className="text-sm text-muted-foreground dark:text-white/70">Hantera material</div>
              </div>
            </div>
          </button>
        </div>
      ...
      <div className="mt-6 grid md:grid-cols-3 gap-4">
        <div
          className="cursor-pointer rounded-2xl border border-border/60 bg-[var(--color-card)] shadow-sm transition-all hover:-translate-y-0.5 hover:border-orange-500 hover:shadow-lg dark:border-border/40 dark:bg-[var(--color-card)]/80 dark:text-white/90"
          onClick={() => router.push('/dashboard/projects')}
        >
          <div className="p-5 sm:p-6">
            <div className="text-sm uppercase tracking-[0.18em] text-muted-foreground dark:text-white/70">Aktiva projekt</div>
            <div className="mt-3 text-3xl font-semibold text-foreground dark:text-white">{stats.active_projects}</div>
            <div className="mt-4 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground dark:text-white/80 dark:hover:text-white">
              Visa alla projekt →
            </div>
          </div>
        </div>
        ...
        >
          <div className="p-5 sm:p-6">
            <div className="text-sm uppercase tracking-[0.18em] text-muted-foreground dark:text-white/70">Tidsrapporter v.</div>
            <div className="mt-3 text-3xl font-semibold text-foreground dark:text-white">{stats.total_time_entries_week}</div>
            <div className="mt-4 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground dark:text-white/80 dark:hover:text-white">
              Logga tid →
            </div>
          </div>
        ...
        >
          <div className="p-5 sm:p-6">
            <div className="text-sm uppercase tracking-[0.18em] text-muted-foreground dark:text-white/70">Material & utgifter v.</div>
            <div className="mt-3 text-3xl font-semibold text-foreground dark:text-white">{stats.total_materials_week}</div>
            <div className="mt-4 text-sm font-medium text-muted-foreground transition-colors hover:text-foreground dark:text-white/80 dark:hover:text-white">
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-col gap-3">
          {recentActivities.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-2xl border border-border/60 bg-[var(--color-card)] p-10 text-center shadow-sm dark:border-border/40 dark:bg-[var(--color-card)]/80">
                ...
                {displayedActivities.map((activity) => {
                  ...
                  return (
                    <div 
                      ...
                      className={`rounded-2xl border border-border/60 bg-[var(--color-card)] p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg dark:border-border/40 dark:bg-[var(--color-card)]/80 dark:text-white/90 ${navigationPath ? 'cursor-pointer hover:border-orange-400/40 dark:hover:border-orange-400/40' : ''}`}
                    >
