...
interface WorkOrderTimeManagerApprovalEmailProps {
  managerName: string;
  workerName: string;
...
export const WorkOrderTimeManagerApprovalEmail = ({
  managerName,
  workerName,
  workOrderTitle,
  workOrderNumber,
  ...
  reviewUrl,
  mapImageUrl,
}: WorkOrderTimeManagerApprovalEmailProps) => {
  ...
  return (
    <Html>
      <Head />
      <Preview>Godkänn registrerad tid för {workOrderTitle} - {workerName} har bekräftat</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.paragraph}>
            <strong>{workerName}</strong> har bekräftat den registrerade tiden för arbetsordern <strong>{workOrderTitle}</strong> ({workOrderNumber}).
            Vänligen granska och godkänn nedan.
          </Text>
          ...
          <Section style={styles.summaryBox}>
            ...
            <Text style={styles.summaryItem}>
              <strong>Arbetare:</strong> {workerName}
            </Text>
          </Section>
          ...
          <Section style={styles.buttonSection}>
            <Button href={reviewUrl} style={styles.secondaryButton}>
              📋 Granska arbetsorder
            </Button>
          </Section>
          ...
          <Text style={styles.helperText}>
            Arbetaren har bekräftat att den registrerade tiden stämmer. Klicka på "Godkänn" för att slutföra godkännandeprocessen.
          </Text>
...
export default WorkOrderTimeManagerApprovalEmail;
